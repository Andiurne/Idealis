# Halanian
The dominant language in central [Halisan](../../Geography/Halisan.md), and the lingua franca of wider Halisan, composed piecewise from dialects of the native Jïumannian states as a method of solidarity against Cressân after the [Jïumannian Wars of Expression](../../Chronology/By%20Continent/Halanian%20History.md#Jïumannian%20Wars%20of%20Expression%20(832%20AL)).

## Naming Conventions
### Name Structure
A legal name in Halanian typically consists of three parts, in reading order:
1. Given Name 
2. Primary Surname
...
* **Estageia (F)** \- Lit. “kind wisdom,” a name of benevolent scholars and flamescribes.
...
* **\[NOUN\] + "dig"** \- Lit. “\[NOUN\] blessed,” a common method of forming names from prospective talents.
...
* **Bangarhod (M) / Bangadod (F)** \- Slur for the [Kaithurhi](../../Natural%20Sciences/Biology/Sapient%20Species/Kuthjïuman.md#Kaithurhi), meaning “murderous spear-head.”
